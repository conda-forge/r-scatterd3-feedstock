...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-scatterd3-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10760&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-scatterd3-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-scatterd3` can be installed with:

```
conda install r-scatterd3
```

It is possible to list all of the versions of `r-scatterd3` available on your platform with:
